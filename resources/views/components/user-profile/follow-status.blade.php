<div>
    ...
    <div class="flex justify-left gap-3">
        @if($this->followingCount() > 0)
            <flux:text variant="strong" wire:click="openModalType('following')" class="cursor-pointer">Following</flux:text>
        @else
        ...
        @if($this->followerCount() > 0)
            <flux:text variant="strong" wire:click="openModalType('followers')" class="cursor-pointer">Followers</flux:text>
        @else
