...
<?php $component->withAttributes(['variant' => 'cards','class' => 'max-sm:flex-col','wire:model.live' => 'filters.stats']); ?>
            <?php $__currentLoopData = $this->stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    ...
    <!-- Users Table -->
    <?php if($this->users && $this->users->count() > 0): ?>
    <div class="relative">
