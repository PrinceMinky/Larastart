...
<?php $component->withAttributes(['class' => 'relative flex flex-col gap-2 px-2','group' => 'cards','handle' => 'updateCardPosition','permissions' => 'edit kanban cards','key' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($column['id'])]); ?>
            <?php $__currentLoopData = $column['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['wire:click' => 'showCardForm('.e($column['id']).')','variant' => 'subtle','icon' => 'plus','size' => 'sm','class' => 'w-full justify-start! mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'showCardForm('.e($column['id']).')','variant' => 'subtle','icon' => 'plus','size' => 'sm','class' => 'w-full justify-start! mt-1']); ?>
                Add Task
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
