<div>
    <!-- Post Form -->
    <?php if(Auth::user()->me($this->userId)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::textarea','data' => ['wire:model' => 'status','type' => 'text','class' => 'w-full','placeholder' => 'What are you up to?','rows' => 'auto','resize' => 'none','wire:loading.class' => 'opacity-50','@focus' => 'focused = true','@blur' => 'focused = false','@input' => 'status = $event.target.value']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'status','type' => 'text','class' => 'w-full','placeholder' => 'What are you up to?','rows' => 'auto','resize' => 'none','wire:loading.class' => 'opacity-50','@focus' => 'focused = true','@blur' => 'focused = false','@input' => 'status = $event.target.value']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['type' => 'submit','variant' => 'primary','xShow' => 'focused || status.length > 0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'primary','x-show' => 'focused || status.length > 0']); ?>Post <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    <?php endif; ?>
</div><?php /**PATH C:\Users\micha\Herd\larastart\resources\views\components\user-post\status-form.blade.php ENDPATH**/ ?>