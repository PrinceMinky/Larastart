<?php if(! auth()->user()->me($this->user->id) && $this->mutualFollowers->isNotEmpty() && Auth::user()->hasAccessToUser($this->user) && $this->isBlocked === false): ?>
<div class="mt-4">
...
<?php $component->withAttributes(['class' => '**:ring-zinc-100 dark:**:ring-zinc-800']); ?>
        <?php $__currentLoopData = $this->mutualFollowers->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mutualFollower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
        ...
        <?php if($this->mutualFollowers->count() > 3): ?>
            <?php if (isset($component)) { $__componentOriginal4dcb6e757bd07b9aa3bf7ee84cfc8690 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4dcb6e757bd07b9aa3bf7ee84cfc8690 = $attributes; } ?>
...
<?php endif; ?><?php /**PATH C:\Users\micha\Herd\larastart\resources\views\components\user-profile\mutual-followers.blade.php ENDPATH**/ ?>