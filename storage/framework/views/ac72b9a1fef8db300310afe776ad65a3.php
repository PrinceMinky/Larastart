...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.inbox','data' => ['class' => 'mx-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-2']); ?>No notifications yet <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</div><?php /**PATH C:\Users\micha\Herd\larastart\resources\views/components/notifications/dropdown/empty.blade.php ENDPATH**/ ?>